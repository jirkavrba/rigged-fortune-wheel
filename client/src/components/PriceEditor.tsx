            ...
            <ul className="flex flex-col">
                ...
                <li className="flex flex-col items-center">
                    <button onClick={() => setModalShown(true)}
                            className="mt-3 px-10 py-4 bg-black text-white uppercase font-black tracking-wide rounded-xl shadow-xl transition transform hover:scale-95">
                        Přidat novou položku
                    </button>
                </li>
            </ul>

            <PriceEditorModal active={modalShown} onClose={() => setModalShown(false)}
